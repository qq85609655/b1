 ...
 * @Description:
 */
public class ConvertRuleSplitfield extends ConvertRule {

    private List<SplitfieldVo> dataList;
    ...
    public List<SplitfieldVo> getDataList() {
        return dataList;
    }

    public void setDataList(List<SplitfieldVo> dataList) {
